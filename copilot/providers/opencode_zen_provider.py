"""Opencode Zen provider — proxies requests to the Opencode Zen API."""
...
class OpencodeZenProvider(AbstractProvider):
    ...
    label = "Opencode Zen"
    url = "https://api.opencode.ai/zen/v1" # Default placeholder
    working = True
    ...
    def __init__(self, base_url: str | None = None):
        super().__init__()
        self._api_key = os.environ.get("OPENCODE_ZEN_API_KEY", config.get("OPENCODE_ZEN_API_KEY"))
        self._base_url = (base_url or os.environ.get("OPENCODE_ZEN_BASE_URL", "https://api.opencode.ai/zen/v1")).rstrip("/")
        self._models_str = os.environ.get("OPENCODE_ZEN_MODELS", "zen-1,zen-mini")
